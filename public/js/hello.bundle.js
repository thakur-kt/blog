"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["hello.bundle"],{
  ...
  methods: {
    login: function login() {
      axios.get("/sanctum/csrf-cookie").then(function (response) {
        axios.get("/api/auth/login").then(function (response) {
    ...
    profile: function profile() {
      axios.get("/api/me").then(function (response) {
        console.log(response.data.token); // localStorage.setItem("access_token", response.data.token);
      });
    }
  }
});
